import { userLoader } from'@react-three/fiber';
import { useEffect } from 'react';
import { BufferAttribute, Color } from 'three';
import { GLTFLoader } from 'three/examples/jsm/loader/GLTFLoader';

export function Workshop() {
    const gltf = useLoader(GLTFLoader, process.env.PUBLIC_URL + "models/workshop.glb");
